...
class JobOppsAndReferralsSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'pub_date', 'job_title', 'company_name',
...
class SistersSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'first_name', 'last_name', 'nickname',
                  'nickname_meaning', 'chapter', 'crossing_chapter',
                  'crossing_class', 'crossing_date', 'initiation_date',
                  'line_number', 'big_sister', 'tree', 'status',
                  'current_city', 'current_state', 'current_country',
                  'email_address', 'coach', 'current_position', 'current_company',
                  'linkedin_url', 'expertise_interests', 'summary')
